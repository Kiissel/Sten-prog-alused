...
def get_middle_element_of_list(elements: list) -> any:
    ...
    """
    middle_element_index = len(elements) // 2
    return elements[middle_element_index]
...
def add_element_in_position(elements: list, new_element: any, position: int) -> list:
    ...
    add_element.insert(position, new_element)
    return add_element
...
def get_repeated_list(elements: list, repetiton: int) -> list:
    ...
    for i in range(repetiton):
        repeated_list = repeated_list + elements
...
def remove_first_element_from_list(elements: list) -> None:
    ...
    x => [2, 3]
    """
    removed_first_list = elements
    removed_first_list.pop(0)
...
def reverse_list(elements: list) -> list:
    ...
    """
    right_list = elements
    right_list_reversed = right_list[::-1]
    return right_list_reversed